...
export const ContactForm = () => {
    ...
    return (
        ...
        >
            ...
            <button
                type="submit"
                className="justify-center items-center flex gap-2.5 text-sm text-white font-medium whitespace-nowrap bg-[#9B9B9B] mt-6 px-4 py-3 rounded-xl group-hover:bg-[#024B53] transition-colors"
            >
                Submit
            </button>
        </form>
