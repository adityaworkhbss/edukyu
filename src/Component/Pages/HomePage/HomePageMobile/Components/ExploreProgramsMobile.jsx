...
export const ExploreProgramsMobile = () => {
    ...
    const handleNext = () => {
        ...
        const nextIndex = Math.min(currentIndex + 1, programs.length - 1);
        ...
        <section className="mt-8">
            ...
            <div className="flex w-full text-sm text-[#383837] font-normal border-b border-[#E0E0E0] ">
                {tabs.map((tab) => (
                    <button
                        ...
                        className={`flex items-center gap-2.5 justify-center px-5 py-3 ${activeTab === tab.id
            ...
            >
                {programs.map((program, index) => (
                    <article
                        key={program.id}
                        className="w-full flex-shrink-0 border rounded-[30px] overflow-hidden  border-solid border-[#CDCDCD] scroll-snap-align-start flex flex-col"
                    >
                        <div className="p-6">
                            <div className="bg-program-image rounded-lg h-[104px] w-full flex items-center justify-center overflow-hidden">
                                {program.image ? (
                                    <img
                        ...
                        <div className="w-full p-6 pt-0 flex flex-col flex-1">
                            ...
                            <div className="text-[#024B53] font-[Outfit] text-[24px] font-medium leading-[30px] mb-[24px] min-h-[56px] whitespace-normal break-words">
                                {program.title}
                            </div>
