...
const CareerSuccessCardMobile = ({ data }) => {
    ...
    return (
        <div className="bg-[#024B53] text-white rounded-[24px] p-6 pb-[42px] flex flex-col gap-6 font-[Outfit]">
            {/* Top Section */}
            <div className="flex flex-col justify-between gap-10">
                ...
                <div className="flex items-center gap-4">
                    ...
                    />
                    <div>
                        <div className="text-[#FFD23F] font-[Outfit] text-[20px] font-semibold leading-none">
                            {data.name}
                        </div>
                        <div className="text-white font-[Outfit] pt-1 text-[14px] font-normal leading-[20px]">
                ...
                <div className="flex items-center justify-center gap-6 text-center">
                    ...
                    <div className="flex flex-col items-center gap-1 mb-[20px]">
                        <div className="text-[12px] font-semibold text-center text-[#FFD23F] font-[Outfit]">
                            {data.hike}
                        </div>
                        <svg xmlns="http://www.w3.org/2000/svg" width="130" height="8" viewBox="0 0 130 8" fill="none">
                            <path d="M129.62 4.35354C129.815 4.15828 129.815 3.8417 129.62 3.64644L126.438 0.464457C126.243 0.269194 125.926 0.269194 125.731 0.464457C125.536 0.659719 125.536 0.976301 125.731 1.17156L128.559 3.99999L125.731 6.82842C125.536 7.02368 125.536 7.34026 125.731 7.53552C125.926 7.73079 126.243 7.73079 126.438 7.53552L129.62 4.35354ZM0.742188 4L0.742188 4.5L129.267 4.49999L129.267 3.99999L129.267 3.49999L0.742187 3.5L0.742188 4Z" fill="white" />
                        </svg>
                    </div>
            ...
            <div className="flex flex-row justify-between">
                <div className="text-[12px] w-1/4 font-normal text-[rgba(255,255,255,0.80)] font-[Outfit] lowercase">
            ...
            <div className="relative w-full mt-4 text-center">
                {/* Quotation mark */}
                <div className="absolute -top-[20px] left-[24px] -translate-x-1/2 text-white/30 text-[110px] font-semibold leading-none">
                    “
                </div>
                ...
                {data.content && (
                    <button
                        onClick={toggleText}
                        className="mt-3 font-bold relative z-10 mb-[18px]"
...
export default CareerSuccessCardMobile;
