...
import graduate from "@/../public/Resources/Images/graduate.png"

const CareerSuccessCard = () => {
    return (
        <div className="bg-[#024B53] text-white rounded-[24px] p-6 md:p-10 flex flex-col md:flex-row gap-8 items-start max-w-7xl mx-auto">
            {/* Left Section */}
            <div className="flex flex-col items-start gap-4 w-full md:w-[40%]">
                {/* Image + Name + Title */}
                <div className="flex items-center gap-4">
                    <Image
                        src={testimonial_image} // replace with actual path
                        alt="Pooja Sarkar"
                        width={80}
                        height={80}
                    ...
                    />
                    <div>
                        <div className="text-[#F1B934] text-[20px] font-[700] font-[Outfit]">
                            Pooja Sarkar
                        </div>
                        <div className="text-white text-[16px] font-[400] font-[Outfit]">
                ...
                <div className="flex gap-3">
                    <a
                        href="#"
                        className="w-[28px] h-[28px] flex items-center justify-center border border-white rounded-md"
                    >
                ...
                {/* Quote */}
                <div className="mt-4 text-[16px] text-white font-[400] font-[Outfit] leading-normal relative pl-8">
          <span className="absolute text-[48px] left-0 top-[-8px] text-[#ffffff4d] font-bold">
            “
          </span>
                    EduKyu's personalized guidance, in-depth program comparisons, and expert
                    career counseling were invaluable. They didn't just tell me about the
                    programs; they understood my aspirations, my strengths, and my weaknesses,
                    and then matched me with the perfect program. They will not only help you
                    find the right program, but they will equip you with the tools and
                    confidence to transform your career.
                </div>
            </div>

            {/* Right Section */}
            <div className="flex flex-col justify-center items-center gap-3 w-full md:w-[60%] text-center">
                <div className="flex items-center justify-between w-full max-w-md mx-auto">
                    <div className="flex flex-col items-center gap-1">
                        ...
                        />
                        <div className="text-white text-sm font-[Outfit] mt-1">
                            Account Executive
                        </div>
                    </div>

                    <div className="flex flex-col items-center gap-1">
                        <div className="text-[16px] font-[600] font-[Outfit] text-white">
                            25 % Hike
                        </div>
