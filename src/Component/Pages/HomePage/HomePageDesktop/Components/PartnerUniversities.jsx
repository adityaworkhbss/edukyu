...
export const PartnerUniversities = () => {
    const universities = PartnerUniversitiesData.universities.map((univ, index) => ({
        id: String(index + 1),
        name: univ.name,
        logoUrl: 'https://api.builder.io/api/v1/image/assets/fecc5b616d6b4d1daa2c8ed2d9ae0ab4/3de6fd537dfc78c50ec6e38316307cf4eed9dcb5?placeholderIfAbsent=true', // Default logo, you can customize per university
