...
export const CentralImageMobile: React.FC<CentralImageMobileProps> = ({ img }) => {
    return (
        <div className="flex w-[278px] pt-[14.07px] flex-col justify-end items-center absolute h-[460px] left-[360px] top-[201px] max-md:relative max-md:w-full max-md:max-w-[300px] max-md:h-auto max-md:mt-0 max-md:mb-10 max-md:mx-auto max-md:left-0 max-md:top-0 max-sm:max-w-[250px] max-sm:mb-[30px]">
