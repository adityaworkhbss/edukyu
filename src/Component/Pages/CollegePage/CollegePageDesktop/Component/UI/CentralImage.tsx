...
export const CentralImage: React.FC<CentralImageMobileProps> = ({ img }) => {
    return (
        <div className="flex left-[calc(33.33%_-_8px)] flex-col  items-center absolute h-[460px] top-[14px] max-md:relative max-md:w-full max-md:max-w-[300px] max-md:h-auto max-md:mt-0 max-md:mb-10 max-md:mx-auto max-md:left-0 max-md:top-0 max-sm:max-w-[250px] max-sm:mb-[30px]  w-[calc(33.333%_-_32px)]" >
