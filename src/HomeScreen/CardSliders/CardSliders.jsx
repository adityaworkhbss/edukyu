...
//
//     return (
//         <div className="relative w-full px-4 sm:px-2 md:px-6 lg:px-10">
//             {/* Navigation Arrows */}
//             {!isMobile && (
//                 <>
//                     <button
//                         onClick={() => throttleClick(prev)}
//                         disabled={isThrottled}
//                         className={`absolute -left-4 top-1/2 transform -translate-y-1/2 z-10 bg-white text-black p-2 rounded-full shadow-md hover:bg-gray-100 transition-all duration-200 ${
//                             isThrottled ? 'opacity-50 cursor-not-allowed' : ''
//                         }`}
//                     >
//                         <LeftOutlined />
...
//                         onClick={() => throttleClick(next)}
//                         disabled={isThrottled}
//                         className={`absolute -right-4 top-1/2 transform -translate-y-1/2 z-10 bg-white text-black p-2 rounded-full shadow-md hover:bg-gray-100 transition-all duration-200 ${
//                             isThrottled ? 'opacity-50 cursor-not-allowed' : ''
//                         }`}
//                     >
//                         <RightOutlined />
