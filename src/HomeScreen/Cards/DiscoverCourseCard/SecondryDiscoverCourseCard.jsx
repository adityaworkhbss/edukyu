...
const SecondryDiscoverCourseCard = ({
                                imgSrc,
                                title,
                                duration,
                                approved,
    ...
    return (
        <div className="w-full max-w-xs border-[#025E68] h-full min-w-[220px] min-h-[460px] border-[1px] rounded-xl shadow-md flex flex-col p-[20px] my-5">
            ...
            {/* Bottom (button) */}
            <div className="absolute pt-[415px] pl-[35px]">
...
export default SecondryDiscoverCourseCard;
