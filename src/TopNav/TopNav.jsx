...
const TopNav = () => {
    ...
    return (
        <div className="bg-white w-full h-16 shadow-md">
            {isMobile ? (
                <div className="flex items-center h-12 justify-between px-5 bg-white">
                    ...
                    <div className="flex items-center">
                        <img className="items-center" src={Edukyu_logo} alt="Edukyu"></img>
                    </div>
