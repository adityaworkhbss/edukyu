...
const Logo = () => (
    <div className="flex items-center h-[66px]">
        <div className="flex items-center py-[11px] pr-[48px]">
...
const FooterDesktop = () => {
    ...
    return (
        <footer className="bg-[#024B53] text-white">
            <div className="px-14 ">
                <div className="flex justify-between">
                    <div className="pt-[40px]">
                        ...
                        <div className="">
                            <h3 className="text-white pt-[52px] pb-[24px] font-outfit text-[20px] not-italic font-medium leading-normal text-left">Follow us on</h3>
                            <SocialIcons />
                        </div>
                    </div>
            ...
            <div className="pl-[56px] pr-[56px] border-white/10">
